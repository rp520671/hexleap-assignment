...
export default function Component2() {
  ...
  const CollectionCard = (props: CollectionDataType) => {
    ...
    return <div className='p-3 bg-white dark:bg-neutral-700 shadow-lg shadow-slate-200 dark:shadow-slate-950 h-[37rem] w-72 text-center transition-transform duration-300 transform-gpu hover:scale-105'>
    ...
    <>
      <div className="py-10 pb-40">
        ...
        <div className="px-5 relative flex justify-center">
          <p className="absolute top-[43%] left-2 lg:left-20 border p-2 text-blue-500 cursor-pointer border-blue-600 flex justify-center items-center transition-transform duration-300 transform-gpu hover:scale-90">
            <FaChevronLeft />
          </p>
          ...
          <p className="absolute top-[43%] right-2 lg:right-20 border p-2 text-blue-500 cursor-pointer border-blue-600 flex justify-center items-center transition-transform duration-300 transform-gpu hover:scale-90">
            <FaChevronRight />
          </p>
        </div>
      </div>
