...
const Component1 = () => {
  ...
  const PlayerBox = (props: PlayerCard) => {
    return <div className='player-card p-3 bg-white dark:bg-neutral-700 shadow-lg shadow-slate-200 dark:shadow-slate-950 h-[33rem] w-72 sm:w-60 transition-transform duration-300 transform-gpu hover:scale-105'>
      <div className="h-[23rem] w-full">
        <Image
          className='h-full w-full object-cover'
          src={props.image} alt={props.playerName} height={200} width={100} />
      </div>
    ...
    <div className='bg-neutral-100 dark:bg-neutral-800 p-4 md:p-10'>
      ...
      <div className="flex flex-col gap-10 mx-auto w-fit">
        ...
        <div className="flex gap-8 justify-center md:justify-start items-center flex-wrap">
          ...
          <div className='player-card p-3 bg-white dark:bg-neutral-700 shadow-lg shadow-slate-200 dark:shadow-slate-950 h-[33rem] w-72 sm:w-60'>
            ...
            <div className="px-3 py-2.5 border h-[17.4rem] border-slate-300 dark:border-slate-500">
              <p>Advertiement Title</p>
      ...
      <div className="flex justify-center items-center mt-9">
        <button type="button" className='bg-sky-500 text-white font-semibold tracking-wide text-sm px-6 py-2 rounded transition-transform duration-300 transform-gpu hover:scale-105'>See More</button>
